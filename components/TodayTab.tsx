...
import { DayLog, RoutinePart } from "@/lib/types";
  ...
  return (
    <div className="space-y-6">
      ...
      <header>
        ...
        <h1 className="mt-1 font-serif text-4xl capitalize leading-tight text-espresso">
          {fmtLong(today)}
        </h1>
      ...
      {profile.parts.includes("fuerza") && (
        <div className="rounded-xl2 bg-sage/40 px-5 py-4">
          <p className="font-sans text-xs uppercase tracking-wider text-coffee/60">
            Fuerza de hoy
          </p>
          <p className="font-serif text-2xl text-espresso">{muscle}</p>
        </div>
      )}
