  ...
  parts: [
    {
      ...
      place: "En casa",
      exercises: [
        { id: "c1", name: "Movilidad articular", targetValue: 5, unit: "min" },
        { id: "c2", name: "Activación cardio suave", targetValue: 5, unit: "min" },
      ],
    },
    {
      key: "gimnasio",
...
export const energyProfiles: Record<number, EnergyProfile> = {
  5: {
    ...
    emoji: "🔥",
    color: "#9CB07A",
    parts: ["calentamiento", "gimnasio", "fuerza", "yoga"],
    intensity: 1,
  ...
  3: {
    ...
    emoji: "🙂",
    color: "#E6B655",
    parts: ["calentamiento", "gimnasio", "yoga"],
    intensity: 0.6,
